...
# Загружаем данные
train_ds, test_ds = load_datasets(True, augment=True)

# Применение repeat() для загрузки данных
...
def create_model():
    ...
    model = models.Sequential([
        ...
        layers.Dense(LABELS, activation='softmax')  # Количество классов для классификации
    ])
