...
## Исследования и выбор решений (каталог `code/AI/`)

| Документ | Назначение |
|----------|------------|
| [AI/README.md](../AI/README.md) | Обзор интеграции эмоций и ссылки на актуальные доки |
| [AI/solutions/SELECTION.md](../AI/solutions/SELECTION.md) | Обоснование выбора сторонних решений |
| [AI/solutions/IMPLEMENTATION_PLAN.md](../AI/solutions/IMPLEMENTATION_PLAN.md) | Исторический поэтапный план (часть уже закрыта BL-030…BL-037) |
...
*Индекс обновляется при добавлении новых документов в `docs/` или смене ролей файлов.*
